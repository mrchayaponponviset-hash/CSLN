    ...
    <div className="flex flex-col items-center justify-center h-full px-6 md:px-8 lg:px-12 pt-4 md:pt-6 pb-20 animate-fade-in-up">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4">
        <button
          ...
          className="px-10 py-4 bg-[#8c8cf3] text-white rounded-2xl font-bold text-lg hover:brightness-110 hover:scale-[1.02] active:scale-95 transition-all shadow-[0_4px_14px_-4px_rgba(140,140,243,0.4)] disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Generate Exam
        </button>
      </div>
